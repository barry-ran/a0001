      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="index.php"><span class="glyphicon glyphicon-list-alt"></span>网站信息管理</a></li>
		 <li><a href="vip.php"><span class="glyphicon glyphicon-comment"></span>贵宾会员管理</a></li>
		  ...
		  <li><a href="http://www.yunziyuan.com.cn/">5G云资源网</a></li>
		  <li><a href="http://www.yunziyuan.com.cn/">5G云资源网</a></li>		  
    ...
    <div class="form-group">
      <div class="page-header">
		...
		<form action="pingbi.php" method="post">
      	...
      	<form action="pingbi.php" method="post">
			...
			<div class="form-group">
			  <label>要屏蔽网页地址：</label>
			  <div class="form-group">
				  <input  type="text" name="url" class="form-control" placeholder="如：http://www.yunziyuan.com.cn/web.php?id=XXXXXXX" value="" required>
		...
		<form action="pingbi.php" method="post">
              ...
              <label>取消网页屏蔽：</label>
              <div class="form-group">
                <input id="deluser" type="text" name="url" class="form-control" placeholder="如：http://www.yunziyuan.com.cn/web.php?id=XXXXXXX" value="" required>
...
<div class="panel panel-info">
  <div class="panel-heading">
   ...
   <div class="panel-body"> 本后台由144G网页制作站长独立开发，可管理网站会员、网页屏蔽以及修改前台信息等等。若还想修改其他内容请直接修改前台代码，如果不了解请别动代码，以免程序出错。更多资源访问：小皮皮主页<a href="http://home.vip885.cn" title="小皮皮主页">home.vip885.cn</a></div>
</div>
