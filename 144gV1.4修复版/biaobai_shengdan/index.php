      ...
      <div class="fh5co-intro no-js-fullheight">
        <div class="fh5co-intro-text">
          <div class="fh5co-center-position">
            ...
            <h3 class="animate-box"><a href="../web.php?id=RicqLor" style="color:#FFF" target="_blank">点击预览</a></h3>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="fh5co-projects">
	...
	<script>
        function shuru(){
            ...
            con1.value='圣诞祝福网页';
            con2..value='./biaobai_shengdan/tx.jpg';
            con3.value='圣诞节快乐';
            con4.value='祝你享尽圣诞佳节的快乐和圣诞的礼品。';
			con5.value='123456';
			con6.value='http://p2.music.126.net/eKmyz2-WnvAT_a7HdkwoxA==/3438172865772138.mp3';
        }
    </script> 
  <!-- END #fh5co-projects -->
  <div id="fh5co-info">
