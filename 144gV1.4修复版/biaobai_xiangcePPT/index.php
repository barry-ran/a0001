      ...
      <div class="fh5co-intro no-js-fullheight">
        <div class="fh5co-intro-text">
          <div class="fh5co-center-position">
            ...
            <h3 class="animate-box"><a href="../web.php?id=RXRiknZ" style="color:#FFF" target="_blank">点击预览</a></h3>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="fh5co-projects">
	...
	<script>
        function shuru(){
			...
			con1.value='Slide';
            con2.value='One';
            con3..value='./biaobai_xiangcePPT/img/1.jpg';
            con4.value='Slide';
			con5.value='Two';
			con6..value='./biaobai_xiangcePPT/img/2.jpg';
			con7.value='Slide';
			con8.value='Three';
            con9..value='./biaobai_xiangcePPT/img/3.jpg';
            con10.value='Slide';
            con11.value='Four';
			con12..value='./biaobai_xiangcePPT/img/4.jpg';
			con13.value='Slide';
			con14.value='Five';
			con15..value='./biaobai_xiangcePPT/img/5.jpg';
			con16.value='next';
			con17.value='http://m2.music.126.net/LHlrmW906j7SAkf5le2OuA==/19057835044339712.mp3';
			con18.value='回忆相册PPT';
        }
    </script> 
  <!-- END #fh5co-projects -->
