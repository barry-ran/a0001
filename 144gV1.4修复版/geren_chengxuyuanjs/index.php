      ...
      <div class="fh5co-intro no-js-fullheight">
        <div class="fh5co-intro-text">
          <div class="fh5co-center-position">
            ...
            <h3 class="animate-box"><a href="../web.php?id=Ra8DNBf" style="color:#FFF" target="_blank">点击预览</a></h3>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="fh5co-projects">
	...
	<script>
        function shuru(){
			...
			con8.value='PHP优化';
			con9.value='精通PS';
			con10.value='唯一QQ：123456';
			con11..value='./geren_chengxuyuanjs/picture/ewm.jpg';
        }
    </script> 
  <!-- END #fh5co-projects -->
  <div id="fh5co-info">
