      ...
      <div class="fh5co-intro no-js-fullheight">
        <div class="fh5co-intro-text">
          <div class="fh5co-center-position">
            ...
            <h3 class="animate-box"><a href="../web.php?id=Ri4wKj5" style="color:#FFF" target="_blank">点击预览</a></h3>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="fh5co-projects">
	...
	<script>
        function shuru(){
            ...
            con1.value='144G网页制作';
            con2..value='./geren_fensepiaoye/tx.jpg';
            con3.value='粉色飘叶个人主页';
            con4.value='144G网页制作，国内顶尖自动化网页制作系统';
			con5.value='做全网最专业的网页制作系统';
			con6.value='123456';
			con7.value='http://p2.music.126.net/TkVXDADz7VjDHM4drkCuig==/5724057534301320.mp3';
        }
    </script> 
  <!-- END #fh5co-projects -->
  <div id="fh5co-info">
