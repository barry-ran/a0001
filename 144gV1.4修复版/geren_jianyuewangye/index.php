      ...
      <div class="fh5co-intro no-js-fullheight">
        <div class="fh5co-intro-text">
          <div class="fh5co-center-position">
            ...
            <h3 class="animate-box"><a href="../web.php?id=Ri5Iq4P" style="color:#FFF" target="_blank">点击预览</a></h3>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="fh5co-projects">
	...
	<script>
        function shuru(){
            ...
            con1.value='144G网页制作';
            con2..value='./geren_jianyuewangye/images/men1.jpg';
            con3.value='简约个人网页';
            con4.value='我的简约个人网页';
			con5.value='144G网页制作，国内顶尖自动化网页制作系统';
			con6.value='123456';
			con7.value='Copyright ©2020 Yunziyuan';
			con8.value='http://m2.music.126.net/M8Xpg-FodO2lfcy0PBNNlQ==/1406275375593099.mp3';
        }
    </script> 
  <!-- END #fh5co-projects -->
  <div id="fh5co-info">
