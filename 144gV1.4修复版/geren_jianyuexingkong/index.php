      ...
      <div class="fh5co-intro no-js-fullheight">
        <div class="fh5co-intro-text">
          <div class="fh5co-center-position">
            ...
            <h3 class="animate-box"><a href="../web.php?id=RXThJAI" style="color:#FFF" target="_blank">点击预览</a></h3>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="fh5co-projects">
	...
	<script>
        function shuru(){
            ...
            con3..value='./';
            con4.value='123456';
            con5.value='144G是一款全自动在线网页制作工具，国内顶尖自动化网页制作系统，只需选择模板一键生成即可。可制作一系列个人网页、表白网页、HTML5网页等等，人人都能做网页。';
			con6.value='http://p2.music.126.net/pOH2QXwQc_7IX4l2sB-iSA==/7954966629620463.mp3';
        }
    </script> 
  <!-- END #fh5co-projects -->
  <div id="fh5co-info">
