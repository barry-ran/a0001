      ...
      <div class="fh5co-intro no-js-fullheight">
        <div class="fh5co-intro-text">
          <div class="fh5co-center-position">
            ...
            <h3 class="animate-box"><a href="../web.php?id=Ri56B50" style="color:#FFF" target="_blank">点击预览</a></h3>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="fh5co-projects">
	...
	<script>
        function shuru(){
            ...
            con2.value='骷髅头个人主页';
            con3.value='我的首页';
            con4.value='http://www.yunziyuan.com.cn';
			con5.value='个人主页';
			con6..value='./web.php?id=Ri4rYMY';
			con7.value='在线收徒';
			con8..value='./web.php?id=Ri5LAvm';
			con9.value='个人业务';
			con10..value='./web.php?id=RiqN6HT';
			con11.value='123456';
			con12.value='公告：144G是一款全自动在线网页制作工具，国内顶尖自动化网页制作系统，只需选择模板一键生成即可。可制作一系列个人网页、表白网页、HTML5网页等等，人人都能做网页。';
			con13.value='http://m2.music.126.net/6uiRR8VLGTJ784KSKwbi9A==/3350211931087769.mp3';
        }
    </script> 
  <!-- END #fh5co-projects -->
  <div id="fh5co-info">
