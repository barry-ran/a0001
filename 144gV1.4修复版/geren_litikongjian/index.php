      ...
      <div class="fh5co-intro no-js-fullheight">
        <div class="fh5co-intro-text">
          <div class="fh5co-center-position">
            ...
            <h3 class="animate-box"><a href="../web.php?id=RXEbIRY" style="color:#FFF" target="_blank">点击预览</a></h3>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="fh5co-projects">
	...
	<script>
        function shuru(){
            ...
            con1.value='炫酷立体空间主页';
            con2.value='国内顶尖自动化网页制作系统';
            con3.value='Domain Name：www.yunziyuan.com.cn';
            con4.value='To The Stars';
			con5.value='Web Authoring';
			con6.value='www.yunziyuan.com.cn';
			con7.value='进入主页';
			con8.value='http://www.yunziyuan.com.cn';
			con9.value='http://m2.music.126.net/fyamTWNajxgD04jCR3AqAA==/5879088674054461.mp3';
        }
    </script> 
  <!-- END #fh5co-projects -->
  <div id="fh5co-info">
