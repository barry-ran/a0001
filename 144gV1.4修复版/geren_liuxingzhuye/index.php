      ...
      <div class="fh5co-intro no-js-fullheight">
        <div class="fh5co-intro-text">
          <div class="fh5co-center-position">
            ...
            <h3 class="animate-box"><a href="../web.php?id=Ra8SdLU" style="color:#FFF" target="_blank">点击预览</a></h3>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="fh5co-projects">
	...
	<script>
        function shuru(){
			...
			var con8=document.getElementById('con8');
            con1.value='流星个人主页';
            con2..value='./geren_liuxingzhuye/tx.png';
            con3.value='144G网页制作';
			con4.value='http://www.yunziyuan.com.cn';
			con5.value='123456';
			con6.value='公告：144G是一款全自动在线网页制作工具，国内顶尖自动化网页制作系统，只需选择模板一键生成即可。可制作一系列个人网页、表白网页、HTML5网页等等，人人都能做网页。';
			con7.value='144G';
