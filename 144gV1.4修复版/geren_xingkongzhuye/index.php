      ...
      <div class="fh5co-intro no-js-fullheight">
        <div class="fh5co-intro-text">
          <div class="fh5co-center-position">
            ...
            <h3 class="animate-box"><a href="../web.php?id=Ri5DmX3" style="color:#FFF" target="_blank">点击预览</a></h3>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="fh5co-projects">
	...
	<script>
        function shuru(){
            ...
            con1.value='144G网页制作';
            con2.value='个人星空特效主页';
            con3.value='http://www.yunziyuan.com.cn';
            con4.value='123456';
			con5.value='公告：144G是一款全自动在线网页制作工具，国内顶尖自动化网页制作系统，只需选择模板一键生成即可。可制作一系列个人网页、表白网页、HTML5网页等等，人人都能做网页。';
			con6.value='星空';
			con7.value='星空，浮现在那落寞的黑夜， 他们在向这一片土地招手的那一刻。是温暖，还有希望。它们点缀那片我们的天空， 不知不觉， 这世界黑得温馨。';
			con8.value='Copyright ©2020 Yunziyuan';
			con9.value='http://p2.music.126.net/NtXmSDF8kNJGKyJOK3D8GA==/6668538022554964.mp3';
        }
    </script> 
  <!-- END #fh5co-projects -->
  <div id="fh5co-info">
