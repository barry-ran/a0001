      ...
      <div class="fh5co-intro no-js-fullheight">
        <div class="fh5co-intro-text">
          <div class="fh5co-center-position">
            ...
            <h3 class="animate-box"><a href="../web.php?id=RiblodK" style="color:#FFF" target="_blank">点击预览</a></h3>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="fh5co-projects">
	...
	<script>
        function shuru(){
            ...
            con1.value='144G网页制作';
            con2.value='欢迎来到|在线网页|制作系统|我是小彬|我为自己|代言';
            con3..value='./geren_yindaoye/img/tx.jpg';
            con4.value='个性引导页';
			con5.value='144G网页制作，国内顶尖自动化网页制作系统';
			con6.value='http://www.yunziyuan.com.cn';
			con7.value='123456';
			con8.value='公告：144G是一款全自动在线网页制作工具，国内顶尖自动化网页制作系统，只需选择模板一键生成即可。可制作一系列个人网页、表白网页、HTML5网页等等，人人都能做网页。';
			con9.value='Copyright ©2020 Yunziyuan';
