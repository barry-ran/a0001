      ...
      <div class="fh5co-intro no-js-fullheight">
        <div class="fh5co-intro-text">
          <div class="fh5co-center-position">
            ...
            <h3 class="animate-box"><a href="../web.php?id=RiNX8PT" style="color:#FFF" target="_blank">点击预览</a></h3>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="fh5co-projects">
	...
	<script>
        function shuru(){
            ...
            con1.value='http://qm.qq.com/cgi-bin/qm/qr?k=xz03k2kDCM2lB-YME7fP--fkDrMOCMaG';
			con2.value='1277180438';
			con3.value='@幻の象';
        }
    </script> 
  <!-- END #fh5co-projects -->
