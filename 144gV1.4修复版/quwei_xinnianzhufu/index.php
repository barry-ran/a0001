      ...
      <div class="fh5co-intro no-js-fullheight">
        <div class="fh5co-intro-text">
          <div class="fh5co-center-position">
            ...
            <h3 class="animate-box"><a href="../web.php?id=RicYQiL" style="color:#FFF" target="_blank">点击预览</a></h3>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="fh5co-projects">
	...
	<script>
        function shuru(){
            ...
            con1.value='新年祝福网页';
            con2.value='小彬';
            con3.value='祝您2017年新年快乐！';
            con4.value='新的开始，新的希望；新的一年，新的梦想；新的阳光，新的篇章!';
			con5.value='新的一年您一定会更加顺利！更加美满！';
			con6.value='Copyright ©2020 Yunziyuan';
			con7.value='http://m2.music.126.net/eYkxRs7us7rguTaUAcRtCw==/1268836418488017.mp3';
        }
    </script> 
  <!-- END #fh5co-projects -->
  <div id="fh5co-info">
