...
//$codepay_config['go_url'] = "index.php/home"; 
...
define('DB_PREFIX', 'prefix');  //测试数据表前缀 主要是订单记录表前缀 删除该行将停用测试数据
...
define('DB_USER', "bisuwa_com");  //数据库用户名
define('DB_PWD', "G7TsDk6SSdfMwxdx");//数据库密码
define('DB_NAME', "bisuwa_com");  //数据库名称
 ...
 *
 */
define('DB_USERTABLE', 'prefix_user');  //充值用户所在数据库表名
define('DB_USERMONEY', 'in_points');  //充值用户所在表中的金额字段名
define('DB_USERNAME', 'in_username');  //充值用户名的字段名 根据用户名转换为id
