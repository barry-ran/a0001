...
<body>
<div class="container">
<script type="text/javascript">parent.document.title = \'零度分发平台 Board 管理中心 - 工具 - 站点备份\';if(parent.$(\'admincpnav\')) parent.$(\'admincpnav\').innerHTML=\'工具&nbsp;&raquo;&nbsp;站点备份\';</script>
...
<table class="tb tb2">
<tr><td>压缩解压目录：<input type="text" class="txt" name="dir">留空为根目录</td><td><input type="submit" class="btn" value="开始压缩文件" onclick="form.action=\'?iframe=backup&action=inzip\'" /></td><td><input type="submit" class="btn" value="解压文件" onclick="form.action=\'?iframe=backup&action=unzip\'" /></td><td>';
	echo checkzip();
	echo '</td></tr>
</table>
</form>
