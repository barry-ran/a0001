...
<body>
<div class="container"><script type="text/javascript">parent.document.title = '零度分发 管理中心 - 首页';if(parent.$('admincpnav')) parent.$('admincpnav').innerHTML='首页';</script><div class="itemtitle"><h3>零度分发 管理中心</h3></div>
...
<tr><td class="vtop td24 lineheight">程序版本</td><td class="lineheight smallfont">零度分发 <?php echo IN_VERSION; ?> 简体中文<?php echo strtoupper(IN_CHARSET); ?> <?php echo IN_BUILD; ?></td></tr>
...
<tr><td class="vtop td24 lineheight">版权所有</td><td><span class="bold"><a href="http://<?php echo $_SERVER['HTTP_HOST']; ?>" class="lightlink2" target="_blank">零度分发科技</a></span></td></tr>
<tr><td class="vtop td24 lineheight">签名对接</td><td class="lineheight smallfont team"><a href="http://wpa.qq.com/msgrd?v=3&uin=1379898507&site=EarDev&menu=yes" target="_blank" class="lightlink2 smallfont">自助签名系统对接-点击联系</a></td></tr>
...
<tr><td class="vtop td24 lineheight">旗下域名</td><td class="lineheight"><a href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/" class="lightlink2" target="_blank"><?php echo $_SERVER['HTTP_HOST']; ?></a></td></tr>
</table>
</div>
</body>
</html>
