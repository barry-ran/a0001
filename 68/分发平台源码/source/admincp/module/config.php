...
function main()
{
	echo '<script type="text/javascript">parent.document.title = \'零度分发平台 Board 管理中心 - 全局 - 全局配置\';if(parent.$(\'admincpnav\')) parent.$(\'admincpnav\').innerHTML=\'全局&nbsp;&raquo;&nbsp;全局配置\';</script>
...
<tr><td class="vtop rowform"><input type="text" class="txt" value="';
	echo IN_NAME;
	echo '" name="IN_NAME"></td><td class="vtop tips2">显示在浏览器窗口标题等位置</td></tr>
<table class="tb tb2">
<tr><td colspan="2" class="td27">站点QQ:</td></tr>
<tr><td class="vtop rowform"><input type="text" class="txt" value="';
	echo QQHAO;
	echo '" name="QQHAO"></td><td class="vtop tips2">显示在浏览器窗口标题等位置</td></tr>
<tr><td colspan="2" class="td27">关键字词:</td></tr>
<tr><td class="vtop rowform"><input type="text" class="txt" value="';
	echo IN_KEYWORDS;
	echo '" name="IN_KEYWORDS"></td><td class="vtop tips2">合理的词汇有利于搜索引擎优化</td></tr>
<tr><td colspan="2" class="td27">站点描述:</td></tr>
<tr><td class="vtop rowform"><input type="text" class="txt" value="';
	echo IN_DESCRIPTION;
	echo '" name="IN_DESCRIPTION"></td><td class="vtop tips2">合理的描述有利于搜索引擎优化</td></tr>
<tr><td colspan="2" class="td27">备案信息:</td></tr>
<tr><td class="vtop rowform"><input type="text" class="txt" value="';
	echo IN_ICP;
	echo '" name="IN_ICP"></td><td class="vtop tips2">显示在页面底部等位置</td></tr>
<tr><td colspan="2" class="td27">客服 E-mail:</td></tr>
<tr><td class="vtop rowform"><input type="text" class="txt" value="';
	echo IN_MAIL;
	echo '" name="IN_MAIL"></td><td class="vtop tips2">发邮件时的发件人地址</td></tr>
...
';
	...
	echo '<input class="radio" type="radio" name="IN_MAILOPEN" value="1" onclick="change(1);"';
	if (IN_MAILOPEN == 1) {
		echo " checked";
	}
	echo '>&nbsp;开启</li>
';
	...
	echo '<input class="radio" type="radio" name="IN_MAILOPEN" value="0" onclick="change(2);"';
	if (IN_MAILOPEN == 0) {
		echo " checked";
	}
	echo '>&nbsp;关闭</li>
...
<tr><td class="vtop rowform"><input type="text" class="txt" value="';
	echo IN_MAILSMTP;
	echo '" name="IN_MAILSMTP"></td><td class="vtop tips2">发邮件时所指定的服务器</td></tr>
<tr><td colspan="2" class="td27">E-mail 密码:</td></tr>
<tr><td class="vtop rowform"><input type="text" class="txt" value="';
	echo IN_MAILPW;
	echo '" name="IN_MAILPW"></td><td class="vtop tips2">发邮件时需要验证的密码</td></tr>
</tbody>
...
';
	...
	echo '<input class="radio" type="radio" name="IN_CODEOPEN" value="1" onclick="change(3);"';
	if (IN_CODEOPEN == 1) {
		echo " checked";
	}
	echo '>&nbsp;开启</li>
';
	...
	echo '<input class="radio" type="radio" name="IN_CODEOPEN" value="0" onclick="change(4);"';
	if (IN_CODEOPEN == 0) {
		echo " checked";
	}
	echo '>&nbsp;关闭</li>
...
<tr><td class="vtop rowform"><input type="text" class="txt" value="';
	echo IN_CODE;
	echo '" name="IN_CODE"></td><td class="vtop tips2">管理员登录后台时的安全提问答案</td></tr>
</tbody>
<tr><td colspan="2" class="td27">统计代码:</td></tr>
<tr><td class="vtop rowform"><textarea rows="6" name="IN_STAT" cols="50" class="tarea">';
	echo base64_decode(IN_STAT);
	echo '</textarea></td><td class="vtop tips2">页面底部显示的第三方统计</td></tr>
</table>
<table class="tb tb2">
...
';
	...
	echo '<input class="radio" type="radio" name="IN_OPEN" value="1" onclick="change(5);"';
	if (IN_OPEN == 1) {
		echo " checked";
	}
	echo '>&nbsp;开放</li>
';
	...
	echo '<input class="radio" type="radio" name="IN_OPEN" value="0" onclick="change(6);"';
	if (IN_OPEN == 0) {
		echo " checked";
	}
	echo '>&nbsp;维护</li>
...
<tbody class="sub" id="in_open"';
	if (IN_OPEN != 0) {
		echo " style=\"display:none;\"";
	}
	echo '>
<tr><td colspan="2" class="td27">维护说明:</td></tr>
<tr><td class="vtop rowform"><textarea rows="6" name="IN_OPENS" cols="50" class="tarea">';
	echo IN_OPENS;
	echo '</textarea></td><td class="vtop tips2">前台显示的维护信息</td></tr>
</tbody>
...
function save()
{
	...
	$str = preg_replace("/'QQHAO', '(.*?)'/", "'QQHAO', '" . SafeRequest("QQHAO", "post") . "'", $str);
