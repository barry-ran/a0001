...
<?php function main(){ ?>
<script type="text/javascript">parent.document.title = '管理中心 - 全局 - 业务配置';if(parent.$('admincpnav')) parent.$('admincpnav').innerHTML='全局&nbsp;&raquo;&nbsp;业务配置';</script>
...
<tr><td colspan="2" class="td27">开关签名:</td></tr>
<tr><td class="vtop rowform"><input type="text" class="txt" value="<?php echo IN_SIGN; ?>" name="IN_SIGN" onkeyup="this.value=this.value.replace(/[^\d]/g,'')" onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))"></td><td class="vtop tips2">设置为0可关闭签名功能（任意数字开启）</td></tr>
<tr><td colspan="2" class="td27">补签次数:</td></tr>
