...
function main()
{
	echo '<script type="text/javascript">parent.document.title = \'零度分发平台 Board 管理中心 - 全局 - 支付配置\';if(parent.$(\'admincpnav\')) parent.$(\'admincpnav\').innerHTML=\'全局&nbsp;&raquo;&nbsp;支付配置\';</script>
...
';
	...
	echo '<input class="radio" type="radio" name="IN_PAY" value="1" onclick="change(1);"';
	if (IN_PAY == 1) {
		echo " checked";
	}
	echo '>&nbsp;微信</li>
';
	...
	echo '<input class="radio" type="radio" name="IN_PAY" value="2" onclick="change(2);"';
	if (IN_PAY == 2) {
		echo " checked";
	}
	echo '>&nbsp;支付宝</li>
...
<tr><td class="vtop rowform"><input type="text" class="txt" value="';
	echo IN_WXMCHID;
	echo '" name="IN_WXMCHID"></td><td class="vtop tips2">微信支付商户号，微信审核通过邮件内获取</td></tr>
<tr><td colspan="2" class="td27">API 密钥:</td></tr>
<tr><td class="vtop rowform"><input type="text" class="txt" value="';
	echo IN_WXKEY;
	echo '" name="IN_WXKEY"></td><td class="vtop tips2">登录微信支付商户平台，帐户设置-密码安全-API安全</td></tr>
<tr><td colspan="2" class="td27">应用 ID:</td></tr>
<tr><td class="vtop rowform"><input type="text" class="txt" value="';
	echo IN_WXAPPID;
	echo '" name="IN_WXAPPID"></td><td class="vtop tips2">微信后台开发者中心，获取AppId</td></tr>
</tbody>
<tbody class="sub" id="pay_zfb"';
	if (IN_PAY != 2) {
		echo " style=\"display:none;\"";
	}
	echo '>
...
<tr><td class="vtop rowform"><input type="text" class="txt" value="';
	echo IN_ALIPAYID;
	echo '" name="IN_ALIPAYID"></td><td class="vtop tips2">以2088开头的16位纯数字</td></tr>
<tr><td colspan="2" class="td27">安全检验码:</td></tr>
<tr><td class="vtop rowform"><input type="text" class="txt" value="';
	echo IN_ALIPAYKEY;
	echo '" name="IN_ALIPAYKEY"></td><td class="vtop tips2">以数字和字母组成的32位字符</td></tr>
</tbody>
