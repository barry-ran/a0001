...
function main()
{
	echo '<script type="text/javascript">parent.document.title = \'零度分发平台 Board 管理中心 - 全局 - 上传配置\';if(parent.$(\'admincpnav\')) parent.$(\'admincpnav\').innerHTML=\'全局&nbsp;&raquo;&nbsp;上传配置\';</script>
...
';
	...
	echo '<input class="radio" type="radio" name="IN_REMOTE" value="1" onclick="change(1);"';
	if (IN_REMOTE == 1) {
		echo " checked";
	}
	echo '>&nbsp;开启</li>
';
	...
	echo '<input class="radio" type="radio" name="IN_REMOTE" value="0" onclick="change(2);"';
	if (IN_REMOTE == 0) {
		echo " checked";
	}
	echo '>&nbsp;关闭</li>
...
<tr><td class="vtop rowform"><input type="text" class="txt" value="';
	echo IN_REMOTEPK;
	echo '" name="IN_REMOTEPK"></td><td class="vtop tips2">云存储的扩展目录</td></tr>
<tr><td colspan="2" class="td27">外网域名:</td></tr>
<tr><td class="vtop rowform"><input type="text" class="txt" value="';
	echo IN_REMOTEDK;
	echo '" name="IN_REMOTEDK"></td><td class="vtop tips2">以“<em class="lightnum">http://</em>”开头、“<em class="lightnum">/</em>”结尾</td></tr>
<tr><td colspan="2" class="td27">Bucket:</td></tr>
<tr><td class="vtop rowform"><input type="text" class="txt" value="';
	echo IN_REMOTEBK;
	echo '" name="IN_REMOTEBK"></td><td class="vtop tips2">云存储的空间名称</td></tr>
<tr><td colspan="2" class="td27">AccessKey:</td></tr>
<tr><td class="vtop rowform"><input type="text" class="txt" value="';
	echo IN_REMOTEAK;
	echo '" name="IN_REMOTEAK"></td><td class="vtop tips2">云存储的通信密钥</td></tr>
<tr><td colspan="2" class="td27">SecretKey:</td></tr>
<tr><td class="vtop rowform"><input type="text" class="txt" value="';
	echo IN_REMOTESK;
	echo '" name="IN_REMOTESK"></td><td class="vtop tips2">云存储的通信密钥</td></tr>
</tbody>
