...
echo "?" . str_replace("&step", "&unzip", $_SERVER['QUERY_STRING']);
echo '\';", 3e3);
                }
        }
}
...
<body>
<div class="container">
<script type="text/javascript">parent.document.title = \'零度分发平台 Board 管理中心 - 安装应用\';if(parent.$(\'admincpnav\')) parent.$(\'admincpnav\').innerHTML=\'安装应用\';</script>
