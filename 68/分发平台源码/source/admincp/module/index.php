...
<script type="text/javascript">window.onload = function () {startDrag($(\'_bar\'), $(\'_box\'));}</script>
</head>
...
<div id="notice"><a onclick="$(\'main\').src=\'?iframe=update&setup=checkup\'">您目前使用的 零度分发平台 程序有新版本发布<span>在线升级[<b id="build" style="color:red"></b>]</span></a></div>
...
<div class="mainhd">
<a href="?iframe=index" class="logo">零度分发平台 Administrator\'s Control Panel</a>
<div class="uinfo" id="frameuinfo">
<p>您好, <em>';
echo $_COOKIE['in_adminname'];
echo '</em> [<a href="?action=logout">退出</a>]</p>
...
echo '</p>
	<p>编码: ';
echo strtoupper(IN_CHARSET);
echo '</p>
	<p>更新: ';
echo IN_BUILD;
echo '</p>
	<p>Powered by <a href="/" target="_blank">零度分发</a></p>
	<p>&copy; 2011-';
echo date('Y');
echo ', <a href="/" target="_blank">零度自动签名系统 Inc.</a></p>
</div>
