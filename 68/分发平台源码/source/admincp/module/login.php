...
<tr>
	<td class="login">
		<h1>零度分发平台 Administrator\'s Control Panel</h1>
		<p><a href="http://www.零度分发平台.net" target="_blank">零度分发平台</a> 是 <a href="http://www.零度分发平台.com" target="_blank">零度分发平台</a> 推出的一款以PHP语言开发的Web内容管理系统，帮助网站实现一站式服务。</p>
	</td>
	<td>
...
<tr>
	<td colspan="2" class="footer">
		<div class="copyright">
			<p>Powered by <a href="http://www.零度分发平台.net/" target="_blank">零度分发平台</a> ';
echo IN_VERSION;
echo ' </p>
			<p>&copy; 2011-';
echo date('Y');
echo ', <a href="http://www.零度分发平台.com/" target="_blank">零度分发平台</a> Inc.</p>
		</div>
	</td>
</tr>
</table>
