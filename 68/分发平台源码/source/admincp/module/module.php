...
<script type="text/javascript">parent.document.title = \'零度分发平台 Board 管理中心 - 云平台\';if(parent.$(\'admincpnav\')) parent.$(\'admincpnav\').innerHTML=\'云平台\';</script>
...
echo '</table>
<table class="tb tb2">
<tr><td colspan="15"><div class="fixsel"><a href="';
echo is_ssl() ? str_replace('http://', 'https://', $develop_auth) : $develop_auth;
echo '">获取更多应用</a></div></td></tr>
</table>
</div>
</body>
</html>
