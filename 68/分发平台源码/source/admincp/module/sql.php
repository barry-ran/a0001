...
<body>
<div class="container">
<script type="text/javascript">parent.document.title = \'零度分发平台 Board 管理中心 - 工具 - 执行语句\';if(parent.$(\'admincpnav\')) parent.$(\'admincpnav\').innerHTML=\'工具&nbsp;&raquo;&nbsp;执行语句\';</script>
...
<li>执行前请先确认语句中的表前缀是否为“<em class="lightnum">';
	echo IN_DBTABLE;
	echo '</em>”</li>
</ul></td></tr>
</table>
...
{
	global $db;
	if (md5(md5(SafeRequest("in_pass", "post"))) !== $_COOKIE['in_adminpassword']) {
		exit("<span style=\"color:#C00\">执行失败，登录密码有误！</span>");
	}
