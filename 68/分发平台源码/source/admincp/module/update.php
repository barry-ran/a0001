...
<body>
<div class="container">
<script type="text/javascript">parent.document.title = \'零度分发平台 Board 管理中心 - 程序升级\';if(parent.$(\'admincpnav\')) parent.$(\'admincpnav\').innerHTML=\'程序升级\';</script>
...
function change_data()
{
	...
	echo "<div class=\"infobox\"><br /><h4 class=\"infotitle2\">恭喜！零度分发平台 顺利升级完成！</h4><br /><p class=\"margintop\"><input type=\"button\" class=\"btn\" value=\"完成\" onclick=\"parent.location.href='?iframe=index';\"></p><br /></div>";
}