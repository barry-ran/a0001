...
echo IN_PATH;
;
echo 'source/pack/upload/admin-uplog.php\';
var in_post = \'';
echo $_COOKIE['in_adminid'].'_'.time();
;
echo '\';
var in_size = ';
...
echo IN_PATH;
;
echo 'source/pack/upload/admin-" + response.extension + ".php?time=" + response.time + "&size=" + response.size, true);
       xhr.send(null);
