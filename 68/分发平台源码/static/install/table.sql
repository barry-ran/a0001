...
(7, '阿里云存储[分发]', 'App-oss', 'upload', 0, '零度分发平台', 'http://www.零度分发平台.com/', '2020-03-18 16:22:21'),
(8, '七牛云存储[分发]', 'App-qiniu', 'upload', 0, '零度分发平台', 'http://www.零度分发平台.com/', '2020-03-18 16:22:21');
