...
<div class="zhifu"><span id="payTitle" style="font-size: 17px;">快捷支付：</span>
    ...
    <ul>
		...
		<!--<li>
			<label>
                <input type="radio"  name="pd_FrpId" value="bankwap" style="margin-top:10px;float:left; height:13px;" />
                <div class="iw" style=" padding-top:3px; padding-bottom:3px;background:url(images/bankwap.png) no-repeat center center; margin-left:10px" title="网银WAP"></div>
           </label>
...
<div id="payTypeList" class="bankWrap" style="margin-top:20px; height:auto; overflow:hidden;">
    ...
    <ul>
		...
		<li>
           <label>
                <input type="radio"  name="pd_FrpId" value="bankwap" style="margin-top:10px;float:left; height:13px;" />
                <div class="iw" style=" padding-top:3px; padding-bottom:3px;background:url(images/bankwap.png) no-repeat center center; margin-left:10px;    background-size:auto 100%;" title="网银WAP"></div>
           </label>
        </li>
...
$("input[type='radio']").click(function(){
	...
	if($(this).val()=='bank' || $(this).val()=='bankwap' || $("input[value='bank']:checked").val()=='bank' || $("input[value='bankwap']:checked").val()=='bankwap'){
		$('.banklist').show();
	}else{
		$('.banklist').hide();
	}
