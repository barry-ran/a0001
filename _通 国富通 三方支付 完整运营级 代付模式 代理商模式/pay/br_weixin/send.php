<?php  
    ...
    $data['callback_url']="http://".$_SERVER['HTTP_HOST']."/pay/tf_bankwap/returnUrl.php";
	$data['notify_url']="http://".$_SERVER['HTTP_HOST']."/pay/tf_bankwap/notifyUrl.php";
	$data['memo']='china';
