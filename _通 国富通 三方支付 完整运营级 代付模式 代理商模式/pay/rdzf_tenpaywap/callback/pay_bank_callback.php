...
sysorderid
	网银接口v1.2 版本新增
	此次卡消耗过程中瑞德云系统的订单Id。为保持和以前版本兼容，该值不加入返回结果签名验证。

completiontime
	网银接口v1.2 版本新增
	此次卡消耗过程中瑞德云系统的订单结束时间。格式为年/月/日 时：分：秒，如2010/04/05 21:50:58。
	为保持和以前版本兼容，该值不加入返回结果签名验证。
================================================================================
*/
header('Content-Type:text/html;charset=GB2312');
require_once("../config/pay_config.php");
require_once("../ruide/class.bankpay.php");
...
//进行瑞德云签名认证
$bankpay		= new bankpay();
$bankpay->key	= $ruide_merchant_key;
$bankpay->recive();
