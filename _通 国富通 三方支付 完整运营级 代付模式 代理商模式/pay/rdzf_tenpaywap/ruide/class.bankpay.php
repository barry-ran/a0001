...
class bankpay{
	...
	* 993  财付通网银支付接口URL
	*/
	const ruide_bank_url	= 'http://pay.jubaopengo.net/Bank/';
	
	/*
	* 商户id，由993  993  瑞德云计费分配
	*/
	var $parter;
	...
	*/
	public function send(){
		//检查是否正确
		$error 	= 0;
		$msg		= '您调用瑞德云计费网银支付接口的参数有误，错误信息如下：';
		...
		//最终url
		$url	= bankpay::ruide_bank_url . "?" . $url . "&sign=" .$sign. "&hrefbackurl=". $this->hrefbackurl;				
		// echo $url;
		// die;
		//页面跳转
		return $url;
