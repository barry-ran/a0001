<?php /* *****************************************************************************
# 本程序(WoodyApp)属商业用程序，任何个人或组织不得二次销售，违者将负法律责任！ # 2016-07 v2.0 # 程序作者:yang0
1750ac11a88a8e39849224d076a63f7a316580e0 # 支持邮箱:yang0@outlook.com QQ:859926053
                    ...
                    <?php foreach($lists as $key=>$val):switch($val['is_state']){case '0': $state='
                        ...
                        <tr data-id="<?php echo $val['id']?>">
                            ...
                            <td>
                                <?php echo $val['qq']?>
                                    &nbsp;
                                    <a href="http://dft.zoosnet.net/LR/Chatpre.aspx?id=DFT46714299&lng=cn"
                                    target="_blank">
