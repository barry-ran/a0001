        ...
        <div class="alert alert-warning" style="margin-bottom:0px;border:1px solid #ddd;border-top:0">
         ...
         <div class="panel-body">
            ...
            method="post">
                ...
                <!--<div class="p0" style="display:none">
                    <div class="form-group">
                        <label class="col-md-2 control-label">
                            真实姓名：
                        </label>
					...
					<div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" value="<?php echo $userinfo['bankLinked']?>"
                            placeholder="" disabled><a href="http://www.lianhanghao.com/" target="_blank">点击查询</a>
                        </div>
                    </div>
                </div>-->
                ...
                <div class="p1">
                    ...
                    <div class="form-group" id="cfolist">
                        <label class="col-md-2 control-label">
                        </label>
                        <div class="col-md-6">
                            <div class="panel panel-default">
