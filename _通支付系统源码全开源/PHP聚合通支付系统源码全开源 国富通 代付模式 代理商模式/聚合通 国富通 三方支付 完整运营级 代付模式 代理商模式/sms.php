...
$encode='UTF-8'; 
$username='zhenwei';  //用户名

$password_md5='7240835ee7502289c76f5e9bd4cddb8d';  //32位MD5密码加密，不区分大小写

$apikey='1ac1deb0c9daeb1da2527ecf88697ed9';  //apikey秘钥（请登录 http://m.5c.com.cn 短信平台-->账号管理-->我的信息 中复制apikey）

$mobile= $phone;  //手机号,只发一个号码：13800000001。发多个号码：13800000001,13800000002,...N 。使用半角逗号分隔。

$content='您好，您的验证码是：'.$_SESSION['code'].'【聚合通】';  //要发送的短信内容，特别注意：签名必须设置，网页验证码应用需要加添加【图形识别码】。
