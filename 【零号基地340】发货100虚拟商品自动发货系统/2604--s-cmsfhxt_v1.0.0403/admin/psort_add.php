...
if($S_title!=""){
	mysqli_query($conn,"insert into sl_psort(S_pic,S_title,S_content,S_order,S_sub) values('$S_pic','$S_title','$S_content',$S_order,$S_sub)");
								...
								<div class="col-lg-3">
									...
									<div class="card card-primary">
										...
										<div class="card-header">
											...
											<?php 
													$sql="select * from sl_psort where S_del=0 and S_sub=0 order by S_order asc,S_id desc";
														$result = mysqli_query($conn, $sql);
														if (mysqli_num_rows($result) > 0) {
														while($row = mysqli_fetch_assoc($result)) {
															...
															echo "<a href=\"?S_id=".$row["S_id"]."\" class=\"list-group-item ".$active."\"><b>└ ".$row["S_order"].".".$row["S_title"]."</b><img src=\"../media/".$row["S_pic"]."\" alt=\"<img src='../media/".$row["S_pic"]."' width='300'>\" style=\"height:25px;border-radius:10px;\" class=\"pull-right\"></a>";


															$sql2="select * from sl_psort where S_del=0 and S_sub=".$row["S_id"]." order by S_order asc,S_id desc";
																...
																while($row2 = mysqli_fetch_assoc($result2)) {
																	...
																	echo "<a href=\"?S_id=".$row2["S_id"]."\" class=\"list-group-item ".$active2."\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;└ ".$row2["S_order"].".".$row2["S_title"]."<img src=\"../media/".$row2["S_pic"]."\" alt=\"<img src='../media/".$row2["S_pic"]."' width='300'>\" style=\"height:25px;border-radius:10px;\" class=\"pull-right\"></a>
