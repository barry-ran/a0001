...
$api=json_decode('{"logo":"images/logo.png","title":"发货100 - 虚拟商品自动发货系统","domain":"http://fahuo100.cn"}',true);
...
<div class="top">
	...
	<div class="top-link">
		<ul>
			...
			<li><a href="<?php echo $api["domain"]?>/q2.html" target="_blank">使用帮助</a></li>
...
<div class="main">
	...
	<div class="pright">
		...
		<div class="pr-agreement">
			<?php echo str_replace("{title}",$api["title"],str_replace(PHP_EOL,"<br>",file_get_contents("license.txt")))?>
		</div>
		<div class="btn-box">
      ...
      <table width="1000" border="0" cellspacing="0" cellpadding="0" class="tabletable">
        ...
        <tbody>
            ...
            <tr>
              ...
              echo phpversion();
              if(phpversion()<5.4){
                echo " <span style=\"color:#ff0000;\">[请使用PHP5.4或以上版本]</span>";
              }
...
<?php }else{
	echo "<span style=\"color:#ff0000;\">[PHP版本过低，无法继续安装！请使用PHP5.4或以上版本]</span>";
}?>
...
mysqli_query($conn,"update sl_config set C_title='".$sitename2."',C_email='".$C_email."'");
