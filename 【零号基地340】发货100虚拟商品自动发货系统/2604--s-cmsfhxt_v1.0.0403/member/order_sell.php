...
$sql="select count(O_id) as O_count from sl_orders where not O_state=2 and O_del=0 and O_sellmid=".$M_id." order by O_id desc";
		...
		<div class="container m_top_30">
					<div class="yto-box">
						...
						<div class="panel panel-default">
							...
							$sql="select * from sl_orders where not O_state=2 and O_del=0 and O_sellmid=".$M_id." order by O_id desc limit ".(($page-1)*10).",10";
							$result = mysqli_query($conn,  $sql);
							...
							while($row = mysqli_fetch_assoc($result)) {
								...
								if(getrs("select * from sl_evaluate where E_mid=$M_id and E_oid=$O_id","E_id")==""){
							        ...
							        echo "<tr>
							        <td><img src=\"../media/".$pic."\" height=\"50\" width=\"50\"></td>
							        <td>
