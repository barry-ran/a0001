...
<header>
  ...
  <div class="met-banner-ny vertical-align text-center" style=''>
    <h1 class="vertical-align-middle" style='color:#ffffff;'>[T_title]</h1>
  </div>
</header>
  ...
  <div class="container mobile-not-padding">
    <div class="column-nav">
      <ol class="column-ul">
        ...
        <fh-function>
			$U_id=getrs("select * from sl_menu where U_del=0 and U_type='text' and U_typeid=".$id,"U_id");
			$U_sub=getrs("select * from sl_menu where U_del=0 and U_type='text' and U_typeid=".$id,"U_sub");
            ...
            s[[
              if($row["U_type"]=="text" && $row["U_typeid"]==$id){
                ...
                $active="";
                    ...
                    $api=$api."<li class=\"column-li ".$active."\"> <a href=\"?type=".$row["U_type"]."&id=".$row["U_typeid"]."\" title=\"".$row["U_title"]."\">".$row["U_title"]."</a> </li>";
                ]]
      }
        </fh-function>
