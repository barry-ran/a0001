...
{
    @file_put_contents(ROOT . "KuYun.txt", "余生网络信息系统版权文件，勿删除；光鲜亮丽的程序背后是一直在努力的我们！原创：余生，QQ:2316803263");
    sysmsg("<center><h2>检测到“KuYun”版权文件已被删除</h2><ul><font size=\"4\">如果“KuYun”版权文件被删除，<b>余生网络信息系统将不会运作！</b></font></li></ul><font size=\"4\">系统已为您重新生成该版权文件，刷新页面即可恢复！<ul><font size=\"4\">请尊重余生网络原创企业cms授权系统，勿再次删除！<br/></center>", true);
}

if( !file_exists(ROOT . "install/install.lock") && file_exists(ROOT . "install/index.php") ) 
{
    sysmsg("<h2>检测到无“install.lock”文件</h2><ul><font size=\"4\">如果本站尚未安装余生网络信息cms系统，请<a href=\"/install/\">前往安装</a></font><br>\n<font size=\"4\">如果本站已安装酷享云支付系统，请手动建立一个空的“install.lock”文件放置于“/install”目录下，<br><b>为了您站点安全，在您未完成以上准备工作之前余生网络信息系统将不会运作。</b></font></li></ul><br/>", true);
}
