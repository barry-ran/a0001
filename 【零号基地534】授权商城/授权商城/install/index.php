...
<div class="top">
	...
	<div class="top-link">
		<ul>
			...
			<li><a href="http://www.gzyus.cn" target="_blank">帮助</a></li>
		</ul>
	</div>
...
<div class="main">
	...
	<div class="pright">
		...
		<div class="pr-agreement">
			...
			<strong>一、本授权协议适用且仅适用于 版权所有西安市碑林区余生网络信息服务部保留所有权利版本，官方对本授权协议的最终解释权。</strong>
			...
			<strong>二、协议规定的约束和限制 </strong>
				<p>1、未获商业授权之前，不得将本软件用于商业用途（包括但不限于支付网站、经营性网站、以营利为目的或实现盈利的网站）。购买商业授权请登陆   <a href="https://www.kuxiangcms.com" target="_blank">余生网络信息</a> 了解最新说明。</p>
				<p>2、未经官方许可，不得对本软件或与之关联的商业授权进行出租、出售、抵押或发放子许可证。</p>
				<p>3、不管你的网站是否整体使用 ，还是部份支付功能使用，在你使用了酷享企业授权的网站系统主页上必须加上余生网络信息的官方网址(<a href="https://www.kuxiangcms.com" target="_blank">酷享企业授权系统</a>)的链接。</p>
