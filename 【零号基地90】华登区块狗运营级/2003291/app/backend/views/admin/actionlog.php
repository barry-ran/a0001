...
<div id="toolbar">
    <div class="form-inline" role="form">
        ...
        <div class="form-group">
            <input name="search" class="form-control" type="text" placeholder="管理员ID/账号">
        </div>
...
echo DatalistWidgets::widget([
    'data_url' => Url::toRoute(["admin/ajaxactionlog"]),
    "labels" => $labels,
    "columns" => ["mid", "userid", "username", "ip", "note", "created_at"],
