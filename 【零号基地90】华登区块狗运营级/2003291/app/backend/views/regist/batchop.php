...
echo DatalistWidgets::widget([
    'data_url' => Url::toRoute(["regist/ajaxbatchoplist"]),
    "labels" => $labels,
    "columns" => ["id", "username", "grade_name", "isactivate", "iseal", "invitename","isactivate","up_referrer_id","down_team_id", "cash_wa", "permanent_wa", "free_wa", "created_at", "last_login_at", "login_ip"],
...
?>
    ...
    p.updateMulit({
    url: "<?php echo Url::toRoute("batchsuspend"); ?>",
    ...
    p.updateMulit({
    url: "<?php echo Url::toRoute("batchrelease"); ?>",
