    ...
    <div class="form-inline" role="form">
        <div class="form-group">
            <?php 
                    ...
                    $h["name"] ="失败";
                    array_push($b,$d,$f,$h);
            echo yii\helpers\Html::dropDownList("status", null, yii\helpers\ArrayHelper::merge(["" => "请选择订单状态"], yii\helpers\ArrayHelper::map($b, "id", "name")), ["class" => "selectpicker"]); ?>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <input name="search" class="form-control" type="text" placeholder="用户ID">
        </div>
...
echo DatalistWidgets::widget([
    'data_url' => Url::toRoute(["regist/ajaxcareorder"]),
    "labels" => $labels,
    "columns" => ["mid","id","userid","username","num","price","status","note","ip","created_at","buy_time"],
