...
<div id="toolbar">
    <div class="form-inline" role="form">
        ...
        <div class="form-group">
            <input name="searchin" class="form-control" type="text" placeholder="转入用户名或ID">
        </div>
        <div class="form-group">
            <input name="searchout" class="form-control" type="text" placeholder="转出用户名或ID">
        </div>
...
echo DatalistWidgets::widget([
    'data_url' => Url::toRoute(["regist/ajaxtransferrecord"]),
    "labels" => $labels,
    "columns" => ["mid", "id", "in_username", "out_username","amount","cash_amount", "hcg_amount", "award", "created_at"],
