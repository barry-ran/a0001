<?php
namespace common\components\qiniu_sdk\src\Qiniu\Processing;
...
use common\components\qiniu_sdk\src\Qiniu\Processing\Operation;
...
final class PersistentFop
{
    ...
    public function execute($bucket, $key, $fops, $pipeline = null, $notify_url = null, $force = false)
    {
        ...
        functions::setWithoutEmpty($params, 'pipeline', $pipeline);
        functions::setWithoutEmpty($params, 'notifyURL', $notify_url);
        if ($force) {
            $params['force'] = 1;
        }
