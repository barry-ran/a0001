...
namespace common\components\qiniu_sdk\src\Qiniu;

use common\components\qiniu_sdk\src\Qiniu\Config;
use common\components\qiniu_sdk\src\Qiniu\Processing;
final class functions
{
    ...
    public static function entry($bucket, $key)
    {
        ...
        return functions::base64_urlSafeEncode($en);
    }
     ...
     */
    public static function setWithoutEmpty(&$array, $key, $value)
    {
        if (!empty($value)) {
            $array[$key] = $value;
        }
     ...
     * @author Sherlock Ren <sherlock_ren@icloud.com>
     */
    public static function waterImg(
        $url,
        $image,
        $dissolve = 100,
        $gravity = 'SouthEast',
     ...
     * @author Sherlock Ren <sherlock_ren@icloud.com>
     */
    public static function waterText(
        $url,
        $text,
        $font = '黑体',
        $fontSize = 0,
    ...
    public static function explodeUpToken($upToken)
    {
        ...
        $accessKey = $items[0];
        $putPolicy = json_decode(functions::base64_urlSafeDecode($items[2]));
