...
<section>
    <div class="am-container">
        <div class="am-g">
            <div class="am-u-sm-12 bgBlb tcenter balance color-white" style="background-color:white;height:50px;">
            ...
            <div class="am-u-sm-12 orderPrice">
                <div class="am-u-sm-12 bg-white orderArticle" style="background-color: white;">
                    <div class="am-u-sm-12 orderNav">
                        <div class="orderArticleName fl color-gray" style="border-bottom: 0;"><?php echo Yii::t('app', '请输入出售数额'); ?>:</div>
                    ...
                    <div class="am-u-sm-12 orderNav">
                        <div class="orderArticleName fl color-gray"  style="border:0;margin-bottom: 0;width:30%;"><?php echo Yii::t('app', '出售总额'); ?>:</div>
...
//                var note = $('#note').val();
                ...
                $.ajax({
                    type: "post",
                    data: {number: number,sys_price: sys_price, price: price, bank: bank, bank_num: bank_num, jymm: pwd, method: method},
                    dataType: "json",
                    url: "/trade/tradesell.html",
...
//                                window.location.href = '/trade/selling.html';
                            } else {
                                alert(data.msg);
                                a = false;
                                //  清除输入框密码
