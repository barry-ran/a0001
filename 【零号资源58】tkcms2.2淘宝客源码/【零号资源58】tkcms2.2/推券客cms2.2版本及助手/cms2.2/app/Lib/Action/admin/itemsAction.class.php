...
//		    $parse = parse_url($data['quanurl']);
//			if(!isset($parse['query'])){
//          $this->error('优惠券链接不符合要求！');
//			}
...
//			$data['Quan_id'] = $quanid;
//			$data['quanurl']='https://uland.taobao.com/coupon/edetail?activityId='.$quanid.'&itemId='.$data['num_iid'].'&pid='. trim(C('yh_taobao_pid')) .'&shareurl=true&app=chrome';
