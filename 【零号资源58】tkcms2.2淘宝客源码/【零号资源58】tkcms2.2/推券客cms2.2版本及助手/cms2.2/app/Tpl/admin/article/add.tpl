...
<div class="subnav">
	<div class="content_menu ib_a blue line_x">
		<a href="?g=admin&m=article&a=index&menuid=350" class="on"><em>文章列表</em></a><span>|</span> <a href="?g=admin&?m=article&a=add&menuid=350" class=""><em>添加文章</em></a>    </div>
	</div>
	<!--添加文章-->
					...
					<div class="content_list pad_10">
						<table width="100%" cellspacing="0" class="table_form">
							<tr>
								...
								<td><select class="J_cate_select mr10" data-pid="0" data-uri="{:U('article_cate/ajax_getchilds')}" data-selected="1"></select><input type="hidden" name="cate_id" id="J_cate_id" value="" /></td>
							</tr>
							<tr>
							...
							<tr>
								<th>关联产品 :</th>
								<td><input type="text" name="author" id="author" class="input-text" size="20" required="required" value="{$author}"></td>
							</tr>


							<tr>
								<th>详细内容 :</th>
								<td><textarea name="info" id="info" style="width:88%;height:400px;visibility:hidden;resize:none;"></textarea></td>
							</tr>
							<tr>
								<th>{:L('publish')} :</th>
								<td>
