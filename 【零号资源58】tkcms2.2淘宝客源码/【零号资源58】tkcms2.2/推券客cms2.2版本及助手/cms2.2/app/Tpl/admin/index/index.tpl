...
<div id="header">
	<div class="logo">
<div style="float: left; width: 160px;"><a href="__APP__" target="_blank" title="{:L('website_manage')}" style="FONT-FAMILY: 楷体">推券客联盟</a> </div>		
	<div class="topnav">
			...
			<li class="top_menu"><a href="javascript:;" data-id="{$val.id}" hidefocus="true" style="outline:none;">{$val.name}</a></li>
			</volist>
		</ul>
