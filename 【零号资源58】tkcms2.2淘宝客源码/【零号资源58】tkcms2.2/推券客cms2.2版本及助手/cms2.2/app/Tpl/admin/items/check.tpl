    ...
    <table width="100%" cellspacing="0">
    	...
    	<tbody>
			...
			<notempty name="val['pic_urls']">
				<div class="img_border"><a href="http://detail.tmall.com/item.htm?id={$val.num_iid}" target="_blank"><img src="{:$val['pic_urls']}_400x400" width="32" width="32" class="J_preview" data-bimg="{:$val['pic_url']}_400x400"></a></div>
			<else />
				<div class="img_border"><a href="http://detail.tmall.com/item.htm?id={$val.num_iid}" target="_blank"><img src="{:$val['pic_url']}_400x400" width="32" width="32" class="J_preview" data-bimg="{:$val['pic_url']}_400x400"></a></div>
			</notempty>
                </td>
