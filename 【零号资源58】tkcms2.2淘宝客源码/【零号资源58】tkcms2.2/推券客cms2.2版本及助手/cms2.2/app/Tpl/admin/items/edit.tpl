...
<div class="pad_lr_10">
	<div class="col_tab">
		...
		<table width="100%" cellpadding="2" cellspacing="1" class="table_form">
			...
			<tr>
				<th></th>
				<td><notempty name="info['pic_url']"><img src="{:$info['pic_url']}" width="250"  /><br /></notempty></td>
				<th></th>
				<td><notempty name="info['pic_urls']"><img src="{:$info['pic_urls']}" width="250"  /><br /></notempty></td>
			</tr>
			<tr>
				<th>商品简介 :</th>
