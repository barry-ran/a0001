    ...
    <table width="100%" cellspacing="0">
    	...
    	<tbody>
            ...
            <tr>
                ...
                <td align="right">
                    <div class="img_border"><a href="http://detail.tmall.com/item.htm?id={$val.num_iid}" target="_blank"><img src="{:$val['pic_url']}_200x200" width="32" width="32" class="J_preview" data-bimg="{:$val['pic_url']}"></a></div>
                </td>
