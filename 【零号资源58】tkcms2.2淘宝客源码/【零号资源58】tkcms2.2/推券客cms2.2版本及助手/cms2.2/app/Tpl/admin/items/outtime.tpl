    ...
    <table width="100%" cellspacing="0">
    	...
    	<tbody>
            ...
            <tr>
                ...
                <td align="right">
                    <notempty name="val['pic_url']"><div class="img_border"><a href="http://item.taobao.com/item.htm?id={$val.num_iid}" target="_blank"><img src="{:$val['pic_url']}" width="32" width="32" class="J_preview" data-bimg="{:attach(get_thumb($val['pic_url '],'_m'), 'item')}"></a></div></notempty>
                </td>
