...
<form id="info_form" action="{:U('items_cate/add')}" method="post">
	...
	<table width="100%" class="table_form">
		...
		<tr>
			<th>描述 :</th>
			<td>
				<input type="text" name="remark" id="remark" class="input-text" size="20">
			</td>
		</tr>
		<tr>
			<th>首页显示 :</th>
	...
	<table width="100%" cellpadding="2" cellspacing="1" class="table_form">
		<tr>
			<th>图标:</th>
			<td><input type="text" name="cateimg" id="J_cate_img" placeholder="请填写阿里ICONFONT Class名称" class="input-text fl mr10" style="width:250px" value=""></td>
            <td></td>
			<td>
		</td>
		</tr>
