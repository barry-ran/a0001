...
<div class="dialog_content">
	...
	<table width="100%" class="table_form">
		...
		<tr>
			<th>设为站长 :</th>
			<td>
				<label><input type="radio" name="webmaster" value="1" > {:L('yes')}</label>&nbsp;&nbsp;
				<label><input type="radio" name="webmaster" value="0" > {:L('no')}</label>&nbsp;&nbsp;
			</td>
		</tr>
		...
		<tr>
			<th>站长PID:</th>
			<td>
		{:substr(C('yh_taobao_pid'),0,strripos(C('yh_taobao_pid'),'_'))}_ <input placeholder="PID最后一段" type="input" class="input-text" size="10" name="webmaster_pid">
			</td>
		</tr>
		...
		<tr>
			<th>站长分佣比例:</th>
			<td>
		    <input type="input" placeholder="如：30" class="input-text" size="10" name="webmaster_rate"> %
			</td>
		</tr>
