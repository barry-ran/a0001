...
<style>
.bm-form { border-bottom: dashed 1px #ddd; background-color:#fff; padding:10px 0 0 10px; height: 300px; overflow: hidden; }
...
.bm-form .form-textarea { width:380px; height:100px; }
...
.bm-form .form-btn .btn { width: 145px; height: 50px; line-height: 50px; text-align: center; display: block; color: #fff; font-size: 18px; background: url(/static/tqkpc/images/tag_state.gif) no-repeat 0 -160px; text-shadow:1px 1px #ff4700; border:none; cursor:pointer }
...
<body>
			...
			<table>
				<tbody>
					<tr>
						<th></th>
						<td>
							<textarea id="reason" required="required" name="reason" class="form-textarea" placeholder="如果发现优惠券失效，或者有其它违规行为，欢迎在这里举报给我们。" cols="30" rows="10"></textarea>
						</td>
					</tr>
					<tr>
						<th></th>
						<td>
							<div class="form-btn">
								...
								<input type="submit" name="smt" value="提交举报" class="btn" id="smt">
							</div>
						</td>
					</tr>
				</tbody>
	...
	<yh:load type="js" href="__STATIC__/tqkpc/js/jquery.min.js,__STATIC__/tqkpc/layer/layer.js,__STATIC__/tqkpc/js/clipboard.min.js" />
	<script>
