		...
		<div class="container cl">
			<div class="headlines-l">
				<div class="shai-wrap">
					...
					<div class="shai-con">
						<img src="__STATIC__/tqkpc/images/course.jpg" class="img-responsive"/>
					</div>			
				</div>
			</div>
			<div class="headlines-r">
				...
				<div class="white-bar mb-20">
					<div class="shai-icon">
						...
						<a href="{:U('basklist/course')}{$trackurl}" class="btn btn-main-outline" title=""><i class="iconfont icon-zhangdan"></i>晒单赚积分教程</a> 
					</div>
