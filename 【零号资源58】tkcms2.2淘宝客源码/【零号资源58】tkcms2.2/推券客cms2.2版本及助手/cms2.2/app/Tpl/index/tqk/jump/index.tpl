							...
							<div class="item_containt">
								<div class="jiu_goodsinfo">
									<div class="goods_con" znid="101z3l">
										<div class="pic">
											<img src="{:$item['pict_url']}_400x400" width="400px" height="400px">
										</div>
										<div class="goods_detail">
											...
											<div class="item-like">
												<div class="price_tag"><i>￥</i>
													<if condition="$quan">
														{:$item['zk_final_price']-$quan}
														<else/>
														{$item.zk_final_price}
													</if>
												
													<span class="ori_price">￥{$item.zk_final_price}</span></div>
											...
											<div class="buy-step-text">购买流程</div>
												...
												<if condition="$quanurl">
													<div class="buy-step-first">
														<span>
															<i>领内部券可省</i>
															<b _hover-ignore="1">{$quan}元</b>
														</span>
														<a rel="nofollow" class="coupon-btn" href="{$quanurl}" target="_blank" title="领券后请点击右边按钮下单" _hover-ignore="1">点击领取</a>
													</div>
												...
												<a  class="buy-step-sec buy-btn" rel="nofollow" href="{$item.item_url}{$trackurl}" isconvert="1" data-itemid="{$item.num_iid}" target="_blank">去
													<if condition="$item.user_type eq '0' ">淘宝
														<else/>天猫</if>下单</a>
												<if condition="$quan">	
													<div class="code">
													<p>手机淘宝扫码领券购买<img src="__STATIC__/tqkpc/images/code.jpg" width="20" height="20"></p>
													<img src="/?m=item&a=qrcode&dataurl={:urlencode($quanurl)}" width="120" height="120">
												</div>
												</if>
											</div>
											...
											<yh:item type="orlike" cid="$item['cate_id']">
												<volist name="items_list" id="val" key="i" mod="3">
													<li style="margin-right:8px;">
														<a href="{:U('/item/',array('id'=>$val['id']))}{$trackurl}" class="img cnzzCounter" target="_blank" data-cnzz-type="1" data-cnzz="{$val['id']}">
