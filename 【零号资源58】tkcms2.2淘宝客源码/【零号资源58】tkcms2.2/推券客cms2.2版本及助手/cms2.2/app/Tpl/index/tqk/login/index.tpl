...
<link rel="stylesheet" href="//at.alicdn.com/t/font_498243_okdd65axaa2rcnmi.css" />
<body>
	<!--top-->
	<div class="top">
...
<div class="login-wrap">
	<div class="container cl">
		<div class="login-bg">
			<div class="loginbox">
				<div class="tabBar clearfix"><span class="current"><a href="javascript:;">会员登录</a></span><span class="f-r"><a href="{:U('login/register')}">免费注册</a></span></div>
				<div class="tabCon">
					<form action="{:U('login/login')}" method="post" id="login">
						<div class="input-box cl">
							<i class="iconfont icon-user"></i>
							<input type="tel" name="username" id="phone" class="input-text" placeholder="请输入您的手机号码" />
						</div>
						<div class="input-box cl">
							<i class="iconfont icon-lock"></i>
							<input type="password" class="input-text" name="password" id="password" placeholder="请输入您的密码" />
						</div>
						...
						<div class="input-box cl">
							...
							<a href="http://wpa.qq.com/msgrd?v=3&uin={:C('yh_qq')}&site=qq&menu=yes" class="f-r">忘记密码？联系管理员</a>
						</div>			
						<div class="input-box cl">
							<input type="submit" class="btn btn-main radius size-L" value="登录">
						</div>
					</form>
				</div>
			</div>
