...
<html>
	...
	<script language="JavaScript" src="__STATIC__/tqkwap/js/jquery.min.js"></script>
	</head>
	<body>
		<script>
		...
		<script>
			...
			$(function() {
				...
				if(ua.match(/iphone/i) == "iphone" || ua.match(/ipad/i) == "ipad") {
					...
					$("#go_tip").attr("src", "__STATIC__/tqkwap/images/jump_coupon_ios.png");

				} else {

					$(".safari_top").css("display", "block");

					$("#go_tip").attr("src", "__STATIC__/tqkwap/images/jump_coupon_android.png");
