...
<div class="header">
    ...
    <div class="fr">
    	<ul class="top_nav fr">
        	<li><a href="http://bbs.yhtbk.cc/" target="_blank"><?php echo L('official_bbs');?></a></li>
            <li><a href="http://www.yhtbk.cc/" target="_blank"><?php echo L('user_manual');?></a></li>
        </ul>
        <h2 class="fr"><?php echo L('wellcom_user_yhxia');?></h2>
    </div>
</div>
<div class="content">
	<div class="step fl">
